<h1 class="display-6 fw-semibold mb-2">Novità</h1>
<p class="text-muted mb-4">Scopri gli ultimi prodotti inseriti.</p>
      ...
      <a class="text-decoration-none text-dark" href="<?= BASE_URL ?>/index.php?r=products/show&id=<?= (int)$p['id'] ?>">
        <div class="card product-card h-100">
          ...
          <div class="card-body">
            ...
            <div class="text-muted small">€ <?= number_format((float)$p['price'], 2, ',', '.') ?></div>
          </div>
        </div>
      </a>
    </div>
