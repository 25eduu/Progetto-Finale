...
<div class="d-flex justify-content-between align-items-center mb-4">
  ...
  <div class="d-flex gap-2">
    <a href="<?= BASE_URL ?>/index.php?r=admin/products" class="btn btn-outline-dark rounded-pill px-4">Prodotti</a>
    <a href="<?= BASE_URL ?>/index.php?r=admin/orders"   class="btn btn-outline-dark rounded-pill px-4">Ordini</a>
    <a href="<?= BASE_URL ?>/index.php?r=admin/users"    class="btn btn-dark rounded-pill px-4">Utenti</a>
  </div>
</div>
    ...
    <div class="card border-0 shadow-sm rounded-4">
      <div class="card-body p-4">
        ...
        <?php else: ?>
          <div class="table-responsive">
            <table class="table table-sm align-middle mb-0">
              <thead class="table-light">
                <tr>
                  <th>#</th><th>Cliente</th><th>Stato</th><th class="text-end">Totale</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div class="mt-3">
            <a href="<?= BASE_URL ?>/index.php?r=admin/orders" class="btn btn-outline-dark btn-sm rounded-pill">Vedi tutti gli ordini</a>
          </div>
        <?php endif; ?>
      </div>
    </div>
...
<!-- I dati vengono passati a admin.js tramite variabile globale -->
