...
class AuthController
{
    ...
    public function login(): void
    {
        ...
        // Rate limiting: max 5 tentativi in 5 minuti
        if (!RateLimitHelper::isAllowed('login_attempt', 5, 300)) {
            Flash::error(
                'Troppi tentativi di login. Riprova tra 5 minuti.',
                BASE_URL . '/index.php?r=auth/loginForm'
            );
        }
        ...
        RateLimitHelper::reset('login_attempt');
    ...
    public function register(): void
    {
        ...
        // Validazione password robusta: minimo 8 caratteri, maiuscola, minuscola, numero, speciale
        if (!ValidationHelper::password($password)) {
            Flash::error(
        ...
        Flash::success('Benvenuto in TechShop, ' . htmlspecialchars($fullName, ENT_QUOTES) . '!', BASE_URL . '/index.php');
    }
    ...
    /**
     * Genera Google OAuth state token
     */
    public function googleAuthStart(): void
    {
        ...
        $params = [
            ...
            'redirect_uri'  => BASE_URL . '/index.php?r=auth/googleCallback',
